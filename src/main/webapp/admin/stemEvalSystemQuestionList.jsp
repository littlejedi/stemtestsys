            ...
            <div class="container">
                ...
                <div class="row row-bg">
                    ...
                    <div class="col-md-3">
                          ...
                          <select class="select2" data-minimum-results-for-search="-1" name="qtype" onchange="location.href='<c:url value='/ecadmin/openlist.html' />'">
                            <option value="C">
                                	选择题
                              </option>
                              <option value="O">
                    ...
                    <div class="col-md-4">
                        <div class="widget">
                            <div class="widget-content">
                            	<form action="<c:url value='/ecadmin/questionlist.html' />" method="get" >
                      ...
                      Stem指数（S/T/E/M）
                            ...
                            <c:forEach var="choice" items="${choicelist}">
                                <tr>
                                   ...
                                   <td>
                                      	<a href="<c:url value='/ecadmin/questiondetail.html' />?choiceId=${choice.choiceId}"  choiceId="${choice.choiceId}">查看</a> 
